    ...
    switch (message.type) {
      ...
      default:
        if (message.reply_to) {
          ...
          if ((ref = message.type) !== "file_created" && ref !== "file_shared" && ref !== "file_unshared" && ref !== "file_comment" && ref !== "file_public" && ref !== "file_comment_edited" && ref !== "file_comment_deleted" && ref !== "file_change" && ref !== "file_deleted" && ref !== "star_added" && ref !== "star_removed" && ref !== "reaction_removed" && ref !== "reaction_added") {
